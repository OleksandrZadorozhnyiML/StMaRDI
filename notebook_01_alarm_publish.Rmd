...
In this notebook we aim to perform a simple experiment to estimate the structure between the covariates from the (subset) of dataset "alarm". 
...
__The alarm data set contains the following 37 variables__:
...
[1] Beinlich, I.A., Suermondt, H.J., Chavez, R.M., Cooper, G.F. (1989). The ALARM Monitoring System: A Case Study with two Probabilistic Inference Techniques for Belief Networks. In: Hunter, J., Cookson, J., Wyatt, J. (eds) AIME 89. Lecture Notes in Medical Informatics, vol 38. Springer, Berlin, Heidelberg. https://doi.org/10.1007/978-3-642-93437-7_28
