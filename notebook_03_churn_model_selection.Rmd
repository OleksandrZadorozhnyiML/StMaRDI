---
title: "Churn analysis of the telekom data"
author: Oleksandr Zadorozhnyi (extension of the dataset analysis https://mlcourse.ai/book/topic01/topic01_pandas_data_analysis.html to include causal inference methods and prediction importance)
date: "5/10/2023"
output:
  html_document
...
```{r}
features_excrt = c("intl.plan","intl.calls","customer.calls","voice.plan")
...
[2] Spirtes, P., and Glymour, C., 1991. An Algorithm for Fast Recovery of Sparse Causal Graphs. Social Science Computer Review, vol. 9, Iss. 1, 62–72.

[3] P. Spirtes, C. Glymour, and R. Scheines. Causation, Prediction, and Search. MIT press, 2nd edition,2000.

[4] Tsamardinos, I., Aliferis, C.F. and Statnikov, A., 2003, August. Time and sample efficient discovery of Markov blankets and direct causal relations. In Proceedings of the ninth ACM SIGKDD international conference on Knowledge discovery and data mining (pp. 673-678).

[5] Tsamardinos I, Aliferis CF, Statnikov A (2003). “Algorithms for Large Scale Markov Blanket Discovery.” In “Proceedings of the Sixteenth International Florida Artificial Intelligence Research Society Conference,” pp. 376–381. AAAI Press.
